    ...
    QSplashScreen(pixmap, f)
{
	...
	QString globaltokenText = QChar(0xA9) + QString(" 2016-%1 ").arg(GTC_COPYRIGHT_YEAR) + QString(tr("The Globaltoken developers"));
	...
	pixPaint.drawText(newPixmap.width()-titleTextWidth-paddingRight,paddingTop+titleCopyrightVSpace+12,globaltokenText);
